...
public class CommentController {
    ...
    public List<Comment> getAllCommentsByPostId(@PathVariable (value = "postId") Long postId) {
    	...
    	System.err.println("Post ID is avaliable: "+list.contains(postId));
    ...
    public Comment createComment(@PathVariable (value = "postId") Long postId,
    	...
    	// System.err.println(findPost.getUser().getUsername()+" && "+userdoa.getUsername());
    	// findPost.getUser().getUsername().equals(userdoa.getUsername()); 
    	 ...
    	 List list= postRepository.findByuser(postController.getUserName());
    	  ...
    	  for(Post title : items){
    		if(title.getId()==postId) {
    			System.err.println("===="+title.getId() +" :is : "+postId);
